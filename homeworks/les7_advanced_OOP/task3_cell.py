...
class Cell:
    ...
    def __add__(self, other):
        self.check_instance_of_obj(other)
    ...
    def __sub__(self, other):
        ...
        if self.number_of_cells > other.number_of_cells:
            ...
            raise ValueError("Number of cells can't be <= 0")
    ...
    def check_instance_of_obj(self, other):
        """
        Check if object is instance of Cell class
        :param other: obj
        :return:
        """
        if isinstance(self, type(other)):
            ...
            raise TypeError(f"Support Cell instances only")

    def make_order(self, cells_in_row: int) -> str:
        """
        Order cells in rows
        :param cells_in_row: int
        :return: str
        """
        result = ""
        for cell in range(self.number_of_cells):
            if cell % cells_in_row == 0:
                result += "\n"
            result += "*"
        return result
